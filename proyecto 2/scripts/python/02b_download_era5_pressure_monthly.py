#!/usr/bin/env python3
"""
Ítem 5 — Descarga ERA5 en niveles de presión (promedios mensuales)
Región: 4.0–5.5 N, -76.5 a -75.0
Periodo: 1996–2025

Salida:
- data/raw/era5_pressure_monthly_1996_2025.nc
- data/raw/era5_pressure_request.json
...
def build_request(cfg) -> dict:
    return {
        ...
        "variable": cfg.ERA5_PRESSURE_LEVEL_VARIABLES,
...
def main() -> None:
    ...
    out_nc = project_root / "data" / "raw" / "era5_pressure_monthly_1996_2025.nc"
    out_req = project_root / "data" / "raw" / "era5_pressure_request.json"
    ...
    print("[INFO] Descargando ERA5 en niveles de presión mensual...")
