...
\pagestyle{fancy}
\fancyhf{}
\lhead{\small Journal of Geophysical Research: Atmospheres}
\rhead{\small Mini Proyecto 3}
\rfoot{\thepage}
...
atmósfera local alejada del RCE a lo largo del tiempo. La réplica reproduce fielmente los patrones espaciales del original en ambos paneles.
...
mayoría de los puntos de precipitación intermedia caen por encima de $-105$
(región~3), mientras que en nuestra réplica caen por debajo (región~4). Los
...
y estrechez de la distribución (que es el resultado físico central de esta figura) se reproduce correctamente, confirmando que la atmósfera tropical promediada
...
Las variaciones más notorias se presentan en las regiones de mayor precipitación, Pacífico occidental ($185^\circ$~E) y Continente Marítimo ($125^\circ$~E), donde
